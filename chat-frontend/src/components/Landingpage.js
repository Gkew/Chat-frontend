...
function Landingpage() {
  ...
  return (
    ...
    <form class="bg-white hover:shadow-2xl w-96 h-98 rounded-full justify-center items-center bg-white-400">
      ...
      onClick={googleAuth}
      type="button"
      class="hover:shadow-2xl shadow-2xl justify-center items-center w-40 text-white bg-[#6067ad] hover:bg-[blue-400] focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 font-medium rounded-full text-sm px-5 py-2.5 text-center dark:focus:ring-[#4285F4]/55"
